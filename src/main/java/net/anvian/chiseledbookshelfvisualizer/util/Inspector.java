...
import static net.anvian.chiseledbookshelfvisualizer.ChiseledBookshelfVisualizerClient.*;
...
public class Inspector {
    public void inspect(MinecraftClient client) {
        ...
        if (bookShelfData.latestPos == null) bookShelfData.latestPos = pos;
    ...
    private void bookShelfInspect(BlockPos pos, BlockHitResult blockHitResult, MinecraftClient client) {
        ...
        if (currentBookData.slotId != slotNum && currentBookData.slotId != -2 && !bookShelfData.requestSent) {
            ...
            if (temp == slotNum) bookShelfData.isCurrentBookDataToggled = currentBookData.slotId != -2;
            else {
